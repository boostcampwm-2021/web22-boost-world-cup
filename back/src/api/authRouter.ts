...
router.get('/github/callback', passport.authenticate('github'), controller.oauthCallback);
router.get('/kakao', controller.setCookie, passport.authenticate('kakao'));
router.get('/kakao/callback', passport.authenticate('kakao'), controller.oauthCallback);
